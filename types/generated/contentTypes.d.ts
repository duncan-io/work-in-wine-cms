...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    blogText: Attribute.RichText & Attribute.Required;
...
export interface ApiJobJob extends Schema.CollectionType {
  ...
  attributes: {
    appLink: Attribute.String & Attribute.Required;
    companyDescription: Attribute.RichText;
    companyHQ: Attribute.String;
    ...
    jobCategory: Attribute.Relation<
      'api::job.job',
      'manyToMany',
    ...
    timeOfPayment: Attribute.Enumeration<['perHour', 'perMonth', 'perYear']>;
...
export interface ApiJobAgeJobAge extends Schema.CollectionType {
  collectionName: 'job_ages';
  info: {
    singularName: 'job-age';
    pluralName: 'job-ages';
    displayName: 'jobAge';
    description: '';
  };
